...
function avd( date ) {
	var delay_date = jQuery( "#lf_delivery_option_prep_time" ).val();
	var split_date = delay_date.split('-');
	var delay_days = new Date ( split_date[1] + '/' + split_date[0] + '/' + split_date[2] );
	delay_days.setDate( delay_days.getDate() );
	var noOfDaysToFind = parseInt( jQuery( "#lf_delivery_option_number_of_dates" ).val() );
	...
	var number_of_months = parseInt( jQuery( "#lf_delivery_option_number_of_months" ).val() );
